...
public class Hero {
	...
	public static void slip(Hero hero) {
		...
		System.out.println(hero.getName() +"は、転んで"+ damage +"のダメージを受けた");
		hero.hp -= damage;
		System.out.println(hero.hp +"/"+ hero.maxHp);
	}
